...
/// @title IWallAgentNFT — Wall of 0gents ERC-7857 surface.
interface IWallAgentNFT {
    ...
    function iClone(uint256 tokenId, bytes calldata transferValidityProof) external returns (uint256 newTokenId);
